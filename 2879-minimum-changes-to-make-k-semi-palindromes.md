<h1>2879 - Minimum Changes to Make K Semi-palindromes</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/minimum-changes-to-make-k-semi-palindromes/">minimum-changes-to-make-k-semi-palindromes</a></h2><p>Given a string <code>s</code> and an integer <code>k</code>, partition <code>s</code> into <code>k</code> <strong><span data-keyword="substring-nonempty">substrings</span></strong> such that the letter changes needed to make each substring a <strong>semi-palindrome</strong>&nbsp;are minimized.</p>
